...
type Request struct {
	...
	Message string `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"` //类型 名称 = 序列号
}
...
type Response struct {
	...
	Message string `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"` //序列号从1开始，定义后不允许修改
}
...
var file_echo_proto_rawDesc = []byte{
	...
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x4c, 0x69, 0x6d, 0x65, 0x72, 0x63, 0x2f, 0x45, 0x5f,
	0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x72, 0x63, 0x65, 0x2f, 0x67, 0x6f, 0x6d, 0x61, 0x6c, 0x6c, 0x2f,
