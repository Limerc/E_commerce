...
type kEmailServieClient struct {
	*kClient
}

func (p *kEmailServieClient) Send(ctx context.Context, Req *email.EmailReq, callOptions ...callopt.Option) (r *email.EmailResp, err error) {
