...
var (
	emailServieServiceInfo                = NewServiceInfo()
	emailServieServiceInfoForClient       = NewServiceInfoForClient()
	emailServieServiceInfoForStreamClient = NewServiceInfoForStreamClient()
)

// for server
func serviceInfo() *kitex.ServiceInfo {
	return emailServieServiceInfo
}

// for client
func serviceInfoForStreamClient() *kitex.ServiceInfo {
	return emailServieServiceInfoForStreamClient
}

// for stream client
func serviceInfoForClient() *kitex.ServiceInfo {
	return emailServieServiceInfoForClient
}
...
func newServiceInfo(hasStreaming bool, keepStreamingMethods bool, keepNonStreamingMethods bool) *kitex.ServiceInfo {
	serviceName := "EmailServie"
	handlerType := (*email.EmailServie)(nil)
...
func sendHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(email.EmailServie).Send(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *SendArgs:
		success, err := handler.(email.EmailServie).Send(ctx, s.Req)
		if err != nil {
			return err
		}
