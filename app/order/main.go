...
import (
	...
	"github.com/Limerc/E_commerce/gomall/app/order/biz/dal"
	//"github.com/Limerc/E_commerce/gomall/app/order/biz/service"
	"github.com/Limerc/E_commerce/gomall/app/order/conf"
...
func main() {
	...
	svr := orderservice.NewServer(new(CartServiceImpl), opts...)
