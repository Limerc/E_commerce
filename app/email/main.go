...
import (
	...
	"github.com/Limerc/E_commerce/gomall/app/email/biz/consumer"
	"github.com/Limerc/E_commerce/gomall/app/email/conf"
	"github.com/Limerc/E_commerce/gomall/app/email/infra/mq"
...
func main() {
	...
	mq.Init()
	consumer.Init()
	svr := emailservie.NewServer(new(EmailServieImpl), opts...)
